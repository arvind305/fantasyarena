    ...
    <div className="card animate-slide-up" style={{ animationDelay: "200ms" }}>
      <div className="flex items-start justify-between mb-4">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">
            ...
            <span className={`ml-2 font-semibold ${selected.length >= 2 ? "text-purple-400" : "text-gray-500"}`}>
      ...
      <div className="flex gap-2 mb-2">
        <select
          ...
          disabled={disabled}
          className="flex-1 bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-200 focus:outline-none focus:border-purple-600 disabled:opacity-70 appearance-none"
        >
      ...
      <input
        ...
        disabled={disabled}
        className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-200 mb-2 focus:outline-none focus:border-purple-600 disabled:opacity-70"
      />
