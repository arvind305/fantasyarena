...
ALTER TABLE match_config ADD COLUMN IF NOT EXISTS winner_wrong_points INT DEFAULT 0;

-- Update calculate_match_scores to use winner_wrong_points when answer is wrong.
-- Only change: add ELSE branch in winner scoring (line ~123) to apply penalty.
